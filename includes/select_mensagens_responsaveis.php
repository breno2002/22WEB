...
if ($query_recebeu_4->num_rows >= 1) {
     ...
     $sql_nome_mandou = 'select * from tb_professor where cd_administrador = " '.$row_r4['id_administrador'].' " ';

                    $query_mandou = $mysqli->query($sql_nome_mandou);  

                    $row_mandou = $query_mandou->fetch_array();

                    echo "<p><b>".$row_mandou['nm_professor']."</b> mandou-lhe : ".$row_r4['ds_recado_canal3']."   <b>às ".$row_r4['dt_horario_canal3']."</b></p> " ;
     }
 }
