...
<div id="frame">
	<div id="sidepanel">
		<div id="profile">
			<div class="wrap">
				<img id="profile-img" src="images/14.png" class="online" alt="" />
				<p>Gabriela L.</p>
				<i class="fa fa-chevron-down expand-button" aria-hidden="true"></i>
				<div id="status-options">
					<ul>
						<li id="status-online" class="active"><span class="status-circle"></span> <p>Online</p> <?php 
         ...
         $sql_mat= 'select * from tb_materia where cd_materia = '.$_SESSION['materia'].';'; 
          ...
          ?></li>
				...
				<div id="expanded">
					...
					<input name="twitter" type="text" value="Gabriela Lima" />
					<label for="twitter"><i class="fa fa-twitter fa-fw" aria-hidden="true"></i></label>
					<input name="twitter" type="text" value="@gabrielalll" />
					<label for="twitter"><i class="fa fa-instagram fa-fw" aria-hidden="true"></i></label>
					<input name="twitter" type="text" value="@eugabriela" />
				</div>
			</div>
		</div>
		<div id="search">
	...
	<div class="content">
		...
		<div class="message-input">
			<div class="wrap">
			<input type="text" placeholder="Escrever..." />
